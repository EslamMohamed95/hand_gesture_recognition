...
def create_model(input_shape, output_shape):
    ...
    dropout_1 = Dropout(0.5)(max_pool_1)
    ...
    dropout_2 = Dropout(0.5)(max_pool_2)
    
    
    conv_5 = Convolution2D(128, CONV_5_SIZE, CONV_5_SIZE, init='glorot_uniform', border_mode='same', name='conv_5_{}x{}'.format(CONV_5_SIZE, CONV_5_SIZE))(dropout_2)
    batch_normalization_5 = BatchNormalization(name='batch_normalization_5')(conv_5)
    relu_5 = Activation('relu')(batch_normalization_5)
    
    conv_6 = Convolution2D(128, CONV_6_SIZE, CONV_6_SIZE, init='glorot_uniform', border_mode='same', name='conv_6_{}x{}'.format(CONV_6_SIZE, CONV_6_SIZE))(relu_5)
